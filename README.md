...
In [part-2](part-2) and [part-4](part-4), there are two additional notebooks:
  ...
  * **solutions:** solutions of the project
  ...
  > [!NOTE]
  > The file `https://pivarski-princeton.s3.us-east-1.amazonaws.com/chicago-taxi.parquet`, needed for the part-2 project, has been deleted. It is now [hosted on Zenodo](https://zenodo.org/records/14537442); download it with
  >
  > ```bash
